...
function tableHOC<T extends Object>( columns: Column<T>[],
    ...
    return function HOC(){
        ...
        const {getTableProps , getTableBodyProps , headerGroups , page ,  prepareRow , nextPage , canNextPage , previousPage , canPreviousPage ,gotoPage , pageCount , state : {pageIndex} } = useTable(options , useSortBy , usePagination );
